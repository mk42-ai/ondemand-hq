...
export const COUNTRIES = [
  { iso: 'EG', iso3: 'EGY', name: 'Egypt',      flag: '🇪🇬', lat: 26.8,  lng: 30.8 },
  { iso: 'JO', iso3: 'JOR', name: 'Jordan',     flag: '🇯🇴', lat: 30.6,  lng: 36.2 },
  { iso: 'PK', iso3: 'PAK', name: 'Pakistan',   flag: '🇵🇰', lat: 30.4,  lng: 69.3 },
  { iso: 'KE', iso3: 'KEN', name: 'Kenya',      flag: '🇰🇪', lat: 0.02,  lng: 37.9 },
  { iso: 'MA', iso3: 'MAR', name: 'Morocco',    flag: '🇲🇦', lat: 31.8,  lng: -7.1 },
  { iso: 'ID', iso3: 'IDN', name: 'Indonesia',  flag: '🇮🇩', lat: -0.8,  lng: 113.9 },
  { iso: 'BD', iso3: 'BGD', name: 'Bangladesh', flag: '🇧🇩', lat: 23.7,  lng: 90.4 },
  { iso: 'SD', iso3: 'SDN', name: 'Sudan',      flag: '🇸🇩', lat: 12.9,  lng: 30.2 },
  { iso: 'SO', iso3: 'SOM', name: 'Somalia',    flag: '🇸🇴', lat: 5.2,   lng: 46.2 },
  { iso: 'ET', iso3: 'ETH', name: 'Ethiopia',   flag: '🇪🇹', lat: 9.1,   lng: 40.5 },
  { iso: 'LB', iso3: 'LBN', name: 'Lebanon',    flag: '🇱🇧', lat: 33.9,  lng: 35.9 },
  { iso: 'SY', iso3: 'SYR', name: 'Syria',      flag: '🇸🇾', lat: 34.8,  lng: 38.99 },
  { iso: 'YE', iso3: 'YEM', name: 'Yemen',      flag: '🇾🇪', lat: 15.6,  lng: 48.5 },
  { iso: 'UG', iso3: 'UGA', name: 'Uganda',     flag: '🇺🇬', lat: 1.4,   lng: 32.3 },
  { iso: 'TZ', iso3: 'TZA', name: 'Tanzania',   flag: '🇹🇿', lat: -6.4,  lng: 34.9 },
  { iso: 'RW', iso3: 'RWA', name: 'Rwanda',     flag: '🇷🇼', lat: -1.9,  lng: 29.9 },
];
